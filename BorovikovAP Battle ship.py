...
class BoardOutException(BoardException):
    def __str__(self):
        return "You try to shoot over the board!"

class BoardUsedException(BoardException):
    def __str__(self):
        return "You have already shoot in this spot"
...
class Ship:
    ...
    def dots(self):
        ...
        for i in range(self. length):
            ...
            if self.orientation == 0: #проверить
                cur_x += i
...
class Game:
        ...
        for length in lens:
            while True:
                ...
                try:
                    board.add_ship(ship)
                    break
                except BoardWrongShipException: # проверить
                    pass
        board.begin()
        return board
    ...
    def loop(self):
        ...
        while True:
            print("-"*20)
            print("User playing field:")
            print(self.us.board)
            print("-"*20)
            print("PC playing field:")
            print(self.ai.board)
            if num % 2 == 0:
                print("-"*20)
                print("User turn!")
