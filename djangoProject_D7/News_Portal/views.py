...
from .models import News, Category, BaseRegisterForm, Contact, Appointment
...
class AppointmentView(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # получаем наш html, так же можно дописать что будет приходить
        ...
        msg = EmailMultiAlternatives(
            ...
            from_email='AndreySPB1891@yandex.ru',     # здесь указываете почту, с которой будете отправлять (об этом попозже)
            to=['zoy788@gmail.com', ]  # здесь список получателей. Например, секретарь, сам врач и т. д.
        )
