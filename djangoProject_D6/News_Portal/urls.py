...
from .views import AllNewsList, NewsDetail, Filters, AdNews, NewsUpdate, NewsDelete, BaseRegisterView, IndexView, Upgrade_me, MyView, ContactView, AppointmentView
